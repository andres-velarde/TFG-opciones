function prices = cn_call_am(S_max, T, K, N, M, r, q, sigma, omega, tol, max_iter)
    ...
    % OUTPUT: Matriz de dimensión (N + 1)(M + 1) con la función C(S, t) para todo t_j
    %----------------------------------------------------------------------
    ...
    for j = M + 1:-1:2
        ...
        % Nuevos coeficientes para el paso temporal anterior
