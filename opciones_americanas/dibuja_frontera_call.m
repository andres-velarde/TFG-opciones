% Este código proporciona una gráfica de la frontera libre de una opción de tipo Call americana
%----------------------------------------------------------------------
...
result = cn_call_am(Smax, T, K, N, M, r, q, sigma, omega, tol, it_max);
